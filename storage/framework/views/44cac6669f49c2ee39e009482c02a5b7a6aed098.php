<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">EUGENE TaskApp</a>
        </div>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo e(route('add_task.create')); ?>">Add New Task</a></li>
                        <li><a href="#">Edit/Delete Task</a></li>
                        <li><a href="<?php echo e(route('add_task.index')); ?>">All Task</a></li>
